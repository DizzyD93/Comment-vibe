...
export default function Home() {
  ...
  const analyzeVideo = async () => {
    ...
    try {
      // Progress simulation for blazing fast experimental analysis (300 comments)
                ...
                >
                  {isAnalyzing ? (
                    ...
                    >
                      ...
                      />
                      <span className="hidden sm:inline">Lightning-fast AI analysis...</span>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {progress < 10 ? "🔍 Fetching video data..." :
                       ...
                       progress < 45 ? "⚡ Experimental AI analyzing..." :
          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.7 }}
                className="relative mt-8 p-6 sm:p-8 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-slate-800 dark:via-blue-900/20 dark:to-purple-900/20 border border-blue-200/60 dark:border-blue-700/60 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500"
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 bg-gradient-to-br from-emerald-100/80 to-green-100/80 dark:from-emerald-900/30 dark:to-green-900/30 rounded-2xl border border-emerald-200/50 dark:border-emerald-700/50">
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-blue-100/80 to-cyan-100/80 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-2xl border border-blue-200/50 dark:border-blue-700/50">
                    <div className="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">
                      {Math.round(analysisData.sentiment.positive * 10)}
                    </div>
                    <div className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 font-medium">Positive</div>
                  </div>
                  
                  <div className="text-center p-4 bg-gradient-to-br from-red-100/80 to-pink-100/80 dark:from-red-900/30 dark:to-pink-900/30 rounded-2xl border border-red-200/50 dark:border-red-700/50">
                    <div className="text-2xl sm:text-3xl font-bold text-red-600 dark:text-red-400 mb-1">
                      {Math.round(analysisData.sentiment.negative * 10)}
                    </div>
                    <div className="text-xs sm:text-sm text-red-700 dark:text-red-300 font-medium">Negative</div>
                  </div>
                  
                  <div className="text-center p-4 bg-gradient-to-br from-purple-100/80 to-violet-100/80 dark:from-purple-900/30 dark:to-violet-900/30 rounded-2xl border border-purple-200/50 dark:border-purple-700/50">
            ...
            >
              <div className="mb-6">
                ...
                >
                  ...
                  />
                  <span className="font-medium">Lightning Analysis Complete • 1000+ Comments • Powered by Experimental AI</span>
                  <motion.div
